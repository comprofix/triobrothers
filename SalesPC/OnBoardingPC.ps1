...
C:\windows\system32\cscript.exe //NOLOGO .\OffScrub_O16msi.vbs CLIENTALL
C:\windows\system32\cscript.exe //NOLOGO .\OffScrub_CtoR.vbs
...
# Set TimeZone
 ...
 $files = Get-ChildItem -Path .\Apps -Name

 foreach ($file in $files) {
   Add-AppPackage -Path .\Apps\$file
 }
