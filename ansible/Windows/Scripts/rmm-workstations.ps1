...
$innosetup = 'winagent-v1.6.2.exe'
$api = '"https://api.tbt.net.au"'
$clientid = '1'
$siteid = '1'
...
$rdp = 1
$ping = 1
$auth = '"8da2e5cab876794294507f12edd3e61fbee5e058920583d8fc1cc05712a4d836"'
$downloadlink = 'https://github.com/wh1te909/rmmagent/releases/download/v1.6.2/winagent-v1.6.2.exe'
